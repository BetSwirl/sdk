...
{(() => {
  const games = [
    ...
    },
    {
      emoji: "🎰",
      title: "Slot",
      description: "A slot machine that spins and stops on a symbol. Several configurations of the slot exist, allowing players to take more risks if they wish.",
      image: "/img/games/slot.png"
    }
  ];
