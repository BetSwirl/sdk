...
February 2025 marked another milestone as we launched our **Mini App on Farcaster**, the leading decentralized social media platform. This strategic move proved to be a game-changer:
...
- **Daily Active Users**: The Mini App attracted **several thousand daily users**, proving that web3 gaming can thrive in social environments and creating a new paradigm for decentralized gaming distribution.
