...
4. Add Manifest URL to your app  
    **If you're using our "miniapp-ui-react-demo" template**, add the `FARCASTER_MANIFEST_URL` environment variable with this URL to your Vercel project - see [Add environment variables on Vercel](../##add-environment-variables-on-vercel)   
...
5. [Update your deployment](../##redeploy)
