...
Farcaster hosted manifests simplify updating your Mini App manifest without redeploying your code. It's totally optional and you can still deploy your app without it.
...
4. Add Manifest URL to your app
    **If you're using our "miniapp-ui-react-demo" template**, add the `FARCASTER_MANIFEST_URL` environment variable with this URL to your Vercel project - see [Add environment variables on Vercel](../miniapp##add-environment-variables-on-vercel)
...
5. [Redeploy your app](../miniapp##redeploy)
