...
This guide walks you through creating a Farcaster Mini App using BetSwirl's React UI library.

**What you'll build:** A fully functional multi-game with multi-chain support, custom theming, and background image - exactly like our [live demo](https://farcaster.xyz/miniapps/M926rOlymYrS/betswirl-mini-app-demo).
...
Update `app/providers.tsx` - add this line at the top of the file with other constants if you don't have it already:
...
**2. Add game state inside your App function (before the `addMiniApp` line):**
...
**First, add `gameProps` object after the `addMiniApp` line:**
...
After that, you'll be able to see your manifest and launch the mini-app in the Farcaster Mini App.
...
## Account Association
Account association links the domain to your account. After this, users will be able to add your application to their Farcaster Mini App list. You can generate a signed account association object using the [Mini App Manifest Tool](https://farcaster.xyz/~/developers/mini-apps/manifest) in Farcaster. You need to have the Farcaster app installed on your phone.
...
![Account Association Verify](../screenshots/account-association-verify.png)

2. Copy your `accountAssociation` message and add these variables to your Vercel project.
...
3. [Redeploy your app](#redeploy)
4. Return to the manifest page [Mini App Manifest Tool](https://farcaster.xyz/~/developers/mini-apps/manifest) and refresh it, or click the **"Reverify"** or **"Refresh"** button.
...
- [BetSwirl StoryBook](https://ui-react-storybook.betswirl.com)