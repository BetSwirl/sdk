...
<Tabs items={['Fork Repository', 'From Scratch']}>
  <Tabs.Tab>
**Coming soon**: Fork our ready-to-use React dApp template.

For now, follow the "From Scratch" tab to build your own.
  </Tabs.Tab>
...
### 🏆 Leaderboard "Play now" Integration
