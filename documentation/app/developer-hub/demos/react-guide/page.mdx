...
1. **Download page background**: Right-click → [page-bg.png](https://raw.githubusercontent.com/BetSwirl/ui-react-demo/main/public/page-bg.png) → "Save image as..."
2. **Download game background**: Right-click → [game-bg.png](https://raw.githubusercontent.com/BetSwirl/ui-react-demo/main/public/game-bg.png) → "Save image as..."
...
**2. Update `src/main.tsx` to read affiliate address:**

Add this line at the top with other env variables:
