...
> **Note**: For betting processes, consider using the [@betswirl/ui-react](/developer-hub/sdks/ui-react/getting-started) SDK as an additional package. It provides a full React-based solution that would save you a lot of time, but you'll still need the core SDK as a dependency.
