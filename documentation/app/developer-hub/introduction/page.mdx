...
<PathCardSection>
  <PathCard
    ...
    gradient="green"
    iconGradient="green"
    href="/developer-hub/demos/ui-react/miniapp"
  >
    <PathCardTitle>Low-code option (forking demos)</PathCardTitle>
    <PathCardContent label="Prerequisites" content="Git, Node.js" />
    <PathCardContent label="Result" content="Casino dApp or Farcaster Mini App in one day" />
  </PathCard>
  ...
  <PathCard
    ...
    gradient="blue"
    iconGradient="yellow"
    href="/developer-hub/sdks/react/getting-started"
  >
...
| **UI React Demo (dApp)** | [Guide](/developer-hub/demos/ui-react/react) | [GitHub](https://github.com/BetSwirl/ui-react-demo) |
| **Farcaster UI React Demo (Mini App)** | [Guide](/developer-hub/demos/ui-react/miniapp) | [GitHub](https://github.com/BetSwirl/miniapp-ui-react-demo) |
